...
## Chip Craeting
Img = Image.open(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\ChangeDetection(Label)\Prediction_Label.tif')
out_path = r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\DEM\Labels'
#
# Img = Image.open(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Data\slope.tif')
...
# my_list = []
input_path = r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap'
...
DEM_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\DEM.h5', 'w')
Dist_Built_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Built.h5', 'w')
Dist_Crop_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Crop.h5', 'w')
Dist_Marsh_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Marsh.h5', 'w')
Dist_Open_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Open.h5', 'w')
Dist_Road_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Road.h5', 'w')
Easting_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Easting.h5', 'w')
Northing_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Northing.h5', 'w')
Slope_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Slope.h5', 'w')
...
DEM = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\DEM.h5', 'r')
Dist_Built = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Built.h5', 'r')
Dist_Crop = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Crop.h5','r')
Dist_Marsh = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Marsh.h5','r')
Dist_Open = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Open.h5', 'r')
Dist_Road = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Dist_Road.h5', 'r')
Easting = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Easting.h5', 'r')
Northing = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Northing.h5', 'r')
Slope = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Slope.h5', 'r')
...
## Save in hdf5 format
All_Images_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\All_Images.h5', 'w')
All_Images_hf.create_dataset('All_Images', data=All_Images)
All_Images_hf.close()

Images_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Images.h5', 'w')
Images_hf.create_dataset('Images', data=Images)
Images_hf.close()

Labels_hf = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Labels.h5', 'w')
Labels_hf.create_dataset('Labels', data=Labels)
Labels_hf.close()

##Checking
Images = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Images.h5', 'r')
Images = np.array(Images.get('Images')).astype(np.float32)
print(Images.shape)

Labels = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\Chips_Without_Overlap\HDF\Labels.h5', 'r')
...
tifffile.imwrite(out_path + str(num) + '.tif', Images)
Images = np.reshape(Images, (9, 254, 256, 256 ))
tifffile.imsave(out_path + str(num) + '.tif', Images)
...
Images_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Images.h5', 'w')
Images_hf.create_dataset('Images', data=Images)

DEM_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\DEM.h5', 'w')
Dist_Built_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Built.h5',
    'w')
Dist_Crop_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Crop.h5',
    'w')
Dist_Marsh_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Marsh.h5',
    'w')
Dist_Open_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Open.h5',
    'w')
Dist_Road_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Road.h5',
    'w')
Easting_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Easting.h5', 'w')
Northing_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Northing.h5',
    'w')
Slope_hf = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Slope.h5', 'w')

DEM_hf.create_dataset('DEM', data=DEM_Image)
Dist_Built_hf.create_dataset('Dist_Built', data=Dist_Built_Image)
Dist_Crop_hf.create_dataset('Dist_Crop', data=Dist_Crop_Image)
Dist_Marsh_hf.create_dataset('Dist_Marsh', data=Dist_Marsh_Image)
Dist_Open_hf.create_dataset('Dist_Open', data=Dist_Open_Image)
Dist_Road_hf.create_dataset('Dist_Road', data=Dist_Road_Image)
Easting_hf.create_dataset('Easting', data=Easting_Image)
Northing_hf.create_dataset('Northing', data=Northing_Image)
Slope_hf.create_dataset('Slope', data=Slope_Image)

DEM = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\DEM.h5', 'r')
Dist_Built = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Built.h5',
    'r')
Dist_Crop = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Crop.h5',
    'r')
Dist_Marsh = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Marsh.h5',
    'r')
Dist_Open = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Dist_Open.h5',
...
Dist_Road = h5py.File(
    ...
    'r')
Easting = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Easting.h5', 'r')
Northing = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Northing.h5',
    'r')
Slope = h5py.File(
    r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Slope.h5', 'r')
...
Images = h5py.File(r'E:\Education\MSc\thesis\UrbanExpansion\Data\UrbanExpansion\Predict(2004to2014)\Drivers\HDF5files\Images.h5', 'r')
Images = np.array(Images.get('Images')).astype(np.float32)
print(Images.shape)
