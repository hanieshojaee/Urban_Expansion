...
def eval_image(input_image_path, model, output_image_path):
    ...
    print('model_input_height, model_input_width, model_input_channels:', model_input_height, model_input_width, model_input_channels)
    model_output_height, model_output_width, model_output_channels = model.layers[len(model.layers) - 1].output_shape[1:4]
    print('model_output_height, model_output_width, model_output_channels:', model_output_height, model_output_width, model_output_channels)
...
def evaluate(input_dir, model_path, output_dir):
    ...
    for root, dirs, files in os.walk(input_dir):
        ...
        for f in files:
            ...
            # print(pth)
            out_pth = os.path.join(output_dir, output_dir, 'Predict_with_ModelZhixuhao_BS8_Iouloss_Sigmoid2n_chipsize128x128_epochs10_For2004.tif')
            # print(out_pth)
            eval_image(pth, model, out_pth)
            print('saved result to ' + out_pth)


input_image_dir = r'C:\Users\My PC1\Desktop\U_Net\Predict_Data\input_9depth'
model = r'C:\Users\My PC1\Desktop\U_Net\Model\ModelZhixuhao_BS8_Iouloss_Sigmoid2n_chipsize128x128_epochs10.h5'
output_image_dir = r'C:\Users\My PC1\Desktop\U_Net\Predict_Data\Predicted_Images\ModelZhixuhao_BS8_Iouloss_Sigmoid2n_chipsize128x128_epochs10'
...
def eval_image(input_image_path, model, output_image_path):
    ...
    ## for softmax with 2 neurons:
    label_image = np.array(pred_lc_image[:,:,0])
    print(label_image)
...
def evaluate(input_dir, model_path, output_dir):
    ...
    for root, dirs, files in os.walk(input_dir):
        ...
        for f in files:
            pth = os.path.join(root, f)
            # print(pth)
            out_pth = os.path.join(output_dir, output_dir,
                                   '(0).tif')
            # print(out_pth)
            eval_image(pth, model, out_pth)
            print('saved result to ' + out_pth)
...
input_image_dir = r'C:\Users\My PC1\Desktop\U_Net\Predict_Data\input_9depth'
model = r'C:\Users\My PC1\Desktop\U_Net\Model\Model_Chipsize128x128_epochs_05.h5'
output_image_dir = r'C:\Users\My PC1\Desktop\U_Net\Predict_Data\Predicted_Images\Model_Chipsize128x128_epochs_05\Threshold_On_Zero'
evaluate(input_image_dir, model, output_image_dir)
